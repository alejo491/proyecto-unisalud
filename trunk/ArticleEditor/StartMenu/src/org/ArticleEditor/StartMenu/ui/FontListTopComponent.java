...
package org.ArticleEditor.StartMenu.ui;
...
import org.ArticleEditor.StartMenu.actions.ChooseFontAction; 
 ...
 */
@ConvertAsProperties(
    dtd="-//org.ArticleEditor.Appearance.ui//FontList//EN",
    autostore=false
)
...
@TopComponent.Registration(mode = "palette", openAtStartup = true)
@ActionID(category = "Window", id = "org.ArticleEditor.Appearance.ui.FontListTopComponent")
