...
import org.articleEditor.insertContent.OfficeUIUtils;
...
@ActionID(
        category = "File",
        id = "org.ArticleEditor.StartMenu.actions.OpenInSystemAction")
@ActionRegistration(
...
@Messages({"CTL_OpenInSystemAction=Open in System",
        ...
        "MSG_NotRecognizedUnsupported=This file format is not supported by ArticleEditor.",
