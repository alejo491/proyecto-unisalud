...
@ActionID(
        ...
        id = "org.ArticleEditor.StartMenu.actions.BoldAction")
@ActionRegistration(
        iconBase = "org/ArticleEditor/StartMenu/actions/text_bold.png",
        displayName = "#CTL_BoldAction")
@ActionReferences({
    @ActionReference(path = "Menu/Edit", position = 1520),
    @ActionReference(path = "Toolbars/Font", position = 3800),
